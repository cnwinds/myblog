...
export const DEFAULT_IMAGE_PROMPT_TEMPLATE = `# 角色定义
...
/**
 * 默认的单图提示词模板（用于选中文字生成单图）
 */
export const DEFAULT_SINGLE_IMAGE_PROMPT_TEMPLATE = `你是一位专业的博客视觉内容策划师，擅长为文本内容生成图片生成提示词。
 ...
 * 替换模板中的占位符
 */
export function replaceTemplatePlaceholders(template: string, title: string, content: string): string {
  return template
 ...
 * 替换单图模板中的占位符
 */
export function replaceSingleImageTemplatePlaceholders(template: string, text: string): string {
